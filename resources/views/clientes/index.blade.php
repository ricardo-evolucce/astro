                    ...
                    <div class="col-lg-2 col-md-4 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                        <div class="nav-wrapper position-relative end-0">
                            <ul class="nav nav-pills nav-fill p-1" role="tablist">
                                <li>
                                <a class="btn bg-gradient-dark" href="{{route('clientes.create')}}">Novo Cliente</a>
                                </li>
                                <!--<li class="nav-item">
                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm"><a href="{{route('clientes.show', $cliente)}}">{{$cliente->nome}}</a></h6>
                                            ...
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-bold">{{$cliente->telefone}}</span>
                                            </td>
                                            <td class="align-middle text-center">
                                            ...
                                            <td class="align-middle">
                                                <a rel="tooltip" class="btn btn-success btn-link"
                                                    href="{{route('clientes.edit', $cliente)}}" data-original-title=""
                                                    title="">
                                                    <i class="material-icons">edit</i>
                                                    <div class="ripple-container"></div>
                                                </a>

                                                <form method="post" action="{{route('clientes.destroy', $cliente)}}" style="display:inline-block">
                                                    @csrf
                                                    @method('delete')
