        ...
        <div class="container-fluid px-2 px-md-4">
            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                    ...
                    <div class="col-auto my-auto">
                        <div class="h-100">
                            ...
                            <p class="mb-0 font-weight-normal text-sm">
                                Proprietário: {{$animal->cliente->nome}}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card-body pt-4 p-3">
                            ...
                            <ul class="list-group">
                                ...
                                @foreach($animal->atendimentos as $atendimento)
                                        ...
                                        <div class="d-flex flex-column">
                                            <h6 class="mb-1 text-dark text-sm">
                                                @switch($atendimento->tipoAtendimento)
                                                    @case(1)
                                                        <a href="{{route('atendimentos.show', $atendimento)}}">Consulta Padrão</a>
                                                    @break
                                                    @case(2)
                                                        <a href="{{route('atendimentos.show', $atendimento)}}">Internação</a>
                                                    @break
                                                    @case(3)
                                                        <a href="{{route('atendimentos.show', $atendimento)}}">Banho e Tosa</a>
                                                    @break
                                                    
                                                @endswitch
                                            </h6>
                                            
                                            <span class="text-xs">{{$atendimento->data->format('d/m/Y')}}</span>
                                        </div>
                                    </div>
                ...
                <div class="row tabcontent" id="2">
                    ...
                    <form method="post" action="{{route('clientes.animals.atendimentos.store', ['animal'=> $animal, 'cliente'=> $animal->cliente])}}">
                        <div class="row">
                            ...
                            @endif
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="date" name="data" class="form-control border border-2 p-2" value='{{ old('email', auth()->user()->email) }}'>
                                        @error('email')
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <select class="form-control border border-2 p-2" id="exampleFormControlSelect1" name="status">
                                            ...
                                            <option value="3">Pagamento em aberto</option>
